        ...
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className={`relative transition-all duration-300 ${showResults ? 'max-w-2xl' : 'max-w-2xl mx-auto'}`}>
            <div className={`relative rounded-full border-2 transition-all duration-300 ${
              isSearchFocused ? 'border-blue-500 shadow-lg' : 'border-gray-200 shadow-md'
            } bg-white`}>
              ...
              <Input
                ...
                className="pl-12 pr-4 py-4 text-lg border-0 rounded-full focus:ring-0 focus:outline-none bg-transparent"
              />
            </div>
          </div>
        </div>
        ...
        <div className="max-w-6xl mx-auto px-4 pb-12">
          ...
          {filteredCourses.length === 0 ? (
            <div className="text-center py-12">
              ...
              <p className="text-gray-600">Try searching for different keywords or browse our popular categories.</p>
            </div>
          ) : (
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
              {filteredCourses.map((course) => (
                <Card key={course.id} className="hover:shadow-lg transition-all duration-300 hover:scale-105 cursor-pointer">
